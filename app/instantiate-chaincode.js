...
const collectionsConfigPath = path.resolve(__dirname, './collection_definition.json');
...
const instantiateChaincode = async function (peers, channelName, chaincodeName, chaincodeVersion, chaincodeType, functionName, args, username, org_name) {
	...
	try {
		...
		tx_id = client.newTransactionID(true); // Get an admin based transactionID
		...
		// f40114556ffbee785c98dbf56fa691131e1c1f67888189e248aa9ee85f23a5b0
		if (functionName)
			request.fcn = functionName;

		console.log('amannnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn');
