...
```
curl -s -X POST \ http://localhost:4000/channels \ -H "authorization: {"token":"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9eyJleHAiOjE1ODcyMzYyNzIsInVzZXJuYW1lIjoiSmltIiwib3JnTmFtZSI6Ik9yZzEiLCJpYXQiOjE1ODcyMDAyNzJ9.vx1dhOml1VzFeO0zjmncJKjNRlh7abyVzAw9oj_7iNk"}" \ -H "content-type: application/json" \ -d '{ "channelName":"mychannel", "channelConfigPath":"../artifacts/channel/mychannel.tx"}'
```
...
curl -s -X POST \
  ...
  -d '{
	...
	"chaincodeName":"mycc",
	"chaincodePath":"chaincode/triterrasContract.js",
